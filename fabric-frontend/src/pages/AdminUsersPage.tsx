    ...
    >
      <div className="space-y-6 animate-fade-up">
        ...
        <section className="card p-5 md:p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-3">Role distribution</h2>
          {loading ? (
            ...
            <div className="flex flex-wrap gap-3">
              {roleKeys.map((role) => (
                ...
                >
                  ...
                  <span className="ml-2 font-semibold text-gray-900">{roleCounts[role] ?? 0}</span>
                </div>
              ))}
            </div>
          )}
            ...
            <table className="min-w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-gray-700">Language</th>
                ...
                {loading ? (
                  ...
                  users.map((u) => (
                    <tr key={u.id} className="hover:bg-gray-50/80">
                      ...
                      <td className="px-4 py-3 capitalize text-gray-800">{u.role}</td>
                      <td className="px-4 py-3 text-gray-700">{u.preferredLanguage}</td>
